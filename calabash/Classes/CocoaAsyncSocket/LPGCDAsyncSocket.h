...
extern NSString *const LPGCDAsyncSocketManuallyEvaluateTrust;
#if TARGET_OS_IPHONE
extern NSString *const LPGCDAsyncSocketUseCFStreamForTLS;
#endif
#define LPGCDAsyncSocketSSLPeerName     (NSString *)kCFStreamSSLPeerName
#define LPGCDAsyncSocketSSLCertificates (NSString *)kCFStreamSSLCertificates
#define LPGCDAsyncSocketSSLIsServer     (NSString *)kCFStreamSSLIsServer
extern NSString *const LPGCDAsyncSocketSSLPeerID;
extern NSString *const LPGCDAsyncSocketSSLProtocolVersionMin;
extern NSString *const LPGCDAsyncSocketSSLProtocolVersionMax;
extern NSString *const LPGCDAsyncSocketSSLSessionOptionFalseStart;
extern NSString *const LPGCDAsyncSocketSSLSessionOptionSendOneByteRecord;
extern NSString *const LPGCDAsyncSocketSSLCipherSuites;
#if !TARGET_OS_IPHONE
extern NSString *const LPGCDAsyncSocketSSLDiffieHellmanParameters;
#endif

#define LPGCDAsyncSocketLoggingContext 65535
 ...
 *
 * - LPGCDAsyncSocketManuallyEvaluateTrust
 ...
 *     So LPGCDAsyncSocket will invoke the delegate method socket:shouldTrustPeer: passing the SecTrustRef.
 *
 ...
 *
 * - LPGCDAsyncSocketUseCFStreamForTLS (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     By default LPGCDAsyncSocket will use the SecureTransport layer to perform encryption.
 ...
 *
 *     However, if you absolutely must, you can instruct LPGCDAsyncSocket to use the old-fashioned encryption
 *     technique by going through the CFStream instead. So instead of using SecureTransport, LPGCDAsyncSocket
 ...
 *
 *     Thus all the other keys in the given dictionary will be ignored by LPGCDAsyncSocket,
 ...
 *
 * - LPGCDAsyncSocketSSLSessionOptionFalseStart
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 *     See Apple's documentation for kSSLSessionOptionFalseStart.
 *
 * - LPGCDAsyncSocketSSLSessionOptionSendOneByteRecord
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 ...
 *
 * - LPGCDAsyncSocketSSLDiffieHellmanParameters (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see LPGCDAsyncSocketManuallyEvaluateTrust).
 ...
 *     You MUST use LPGCDAsyncSocketSSLProtocolVersionMin & LPGCDAsyncSocketSSLProtocolVersionMin instead.
...
/**
 * LPGCDAsyncSocket maintains thread safety by using an internal serial dispatch_queue.
 ...
 *
 * Note: If the LPGCDAsyncSocket instance is deallocated while it is still connected,
 ...
 * - LPGCDAsyncSocketManuallyEvaluateTrust == YES
 *
 ...
 **/
- (void)   socket:(LPGCDAsyncSocket *)sock didReceiveTrust:(SecTrustRef)trust
