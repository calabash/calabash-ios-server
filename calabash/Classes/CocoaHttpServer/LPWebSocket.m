 ...
 * This method is called by the LPHTTPConnection it is spawned from.
**/
- (void)start
{
...
- (void)sendResponseHeaders
{
	...
	// Response (Draft 75):
	// 
	// LPHTTP/1.1 101 Web Socket Protocol Handshake
	// Upgrade: LPWebSocket
	// Connection: Upgrade
	...
	// Response (Draft 76):
	//
	// LPHTTP/1.1 101 LPWebSocket Protocol Handshake
	// Upgrade: LPWebSocket
	// Connection: Upgrade
