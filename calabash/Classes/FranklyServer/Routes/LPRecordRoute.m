...
- (NSData *) stopRecording {
  ...
  NSData *plistData = [NSPropertyListSerialization dataFromPropertyList:[[LPRecorder sharedRecorder] events] format:NSPropertyListXMLFormat_v1_0 errorDescription:&error];
  if (error) {
